...
/*  Approach -
    ...
    s = aaaa
    t = bc
    every a in s has 2 choices, either it is replaced by bc or it isnt replaced by bc 
*/
...
void solve()
{
    ...
    {
        ways = (ll)pow(2, s.length()); // length of s is maximum 50, higher powers will overflow in int
    }
    cout << ways << endl;
}
int main()
