...
/*
    ...
    Difficulty - Medium
    Status - Solved
    Coding Sheet - SDE sheet
    Date - floyd's algorithm -  1/2/2024
*/
/*  Approach -
   ...
   have a duplicate.
    ...
    Approach 2 - Floyd's algorithm - Hair and Tortoise method
        1) Take 2 pointers fast and slow
        2) Move the fast pointer 2 steps and the slow pointer only 1 step
        3) when they first intersect, move take another slow pointer at the
   start of the array 4) And now move both the slow pointers by 1 step where
